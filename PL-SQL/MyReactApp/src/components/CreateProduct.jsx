      ...
      <div className="row mt-4">
        ...
        <div className="col-md-6">
          <form onSubmit={(e) => addProduct(e)}>
            <div className="card">
              <div className="card-header">Enter Product Details</div>
              <div className="card-body">
                <div className="mb-4">
                  <label>Product Name: </label>{" "}
                  <span className="badge text-bg-danger">{errmsgName}</span>
                  <input
                    type="text"
                ...
                <div className="mb-4">
                  ...
                  <span className="badge text-bg-danger">{errmsgPrice}</span>
                  <input
                    type="number"
                    className="form-control"
                    onChange={(e) => {
                ...
                <div className="mb-4">
                  ...
                  <span className="badge text-bg-danger">{errmsgsCount}</span>
                  <input
                    type="number"
                    className="form-control"
                    onChange={(e) => {
                      e.target.value !== ""
                        ? seterrmsgsCount("")
                        : seterrmsgsCount("Stock count please");
